  ...
  return (
    <div className={styles.footer}>
      ...
      <ul>
        ...
        >
          <Link href={config.social.github} target="_blank">GitHub</Link>
          <Link href={config.social.linkedin} target="_blank">LinkedIn</Link>
          <Link href={config.social.twitter} target="_blank">X</Link>
          <Link href={config.social.instagram} target="_blank">Instagram</Link>
        </motion.li>
        <motion.li
          custom={[0.3, 0]}
          variants={translate}
          ...
          className="mt-2"
        >
          <Link href={config.social.whatsapp} target="_blank" aria-label="WhatsApp">
